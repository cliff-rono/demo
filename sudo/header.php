  ...
  <div class="wthree_agile_admin_info">
    		  ...
    		  <div class="w3_agileits_top_nav">
    			<ul id="gn-menu" class="gn-menu-main">
    				...
    				<!-- //nav_agile_w3l -->
                    <li class="second logo"><h1><a href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>PIKASH</a></h1></li>
          ...
          -->
    				...
    				<li class="second w3l_search" style="float:right;">
              <br>
    						<span class="fa fa-user">  admin@pikash.net</span>
