...
<div class="form-body">
<form>
    <div class="form-group"> <label for="exampleInputEmail1">Request Loan From</label>
    <input type="text" name"from" placeholder="Email"></input>
    </div>
    ...
    <input type="text" name"amount" placeholder=""></input>
     ...
     <button type="submit" class="btn btn-default">Send Request  <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></button> </form>
</div>
