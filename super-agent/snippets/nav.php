					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Advances <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="request-advance.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Request an Advance</a></li>
									</ul>
								</li>
...
-->
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo"><h1><a href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Esteem </a></h1></li>
